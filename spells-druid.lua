icub3d_Druid_Spells = {
   ...
   icub3d_Spell('help', 'Lifebloom', 'harm', 'Starfall', 'skip', 'skip'),
   icub3d_Spell('help', 'Rejuvenation', 'skip', 'skip'),
   icub3d_Spell('help', 'Efflorescence', 'help', 'Incapacitating Roar', 'skip', 'skip'),
   ...
   icub3d_Macro('im_foam_loot'),
   icub3d_Spell('help', 'Survival Instincts', 'help', 'Celestial Alignment', 'help', 'Tranquility'),
   ...
   icub3d_Spell('harm', 'Solar Beam', 'help', 'Ironbark', 'skip', 'skip'),
