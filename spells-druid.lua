icub3d_Druid_Spells = {
   ...
   icub3d_Spell('help', 'Efflorescence', 'help', 'Incapacitating Roar', 'harm', 'Moonfire',
				'skip', 'skip'),
   ...
   icub3d_Spell('help', 'Survival Instincts', 'help', 'Celestial Alignment',
				'help', 'Tranquility'),
   ...
   icub3d_Spell('both', 'Thrash', 'help', 'Swiftmend', 'skip', 'skip'),
   icub3d_Spell('both', 'Swipe', 'help', 'Wild Growth', 'skip', 'skip'),
   icub3d_Spell('harm', 'Ferocious Bite', 'skip', 'skip'),
   icub3d_Spell('harm', 'Maim', 'skip', 'skip'),
   icub3d_Spell('harm', 'Rip', 'skip', 'skip'),
   icub3d_Spell('help', 'Tiger\'s Fury', 'skip', 'skip'),
   ...
   icub3d_Spell('help', 'Lifebloom', 'harm', 'Starfall', 'skip', 'skip'),
   icub3d_Spell('help', 'Rejuvenation', 'skip', 'skip'),
   icub3d_Spell('help', 'Efflorescence', 'harm', 'Moonfire', 'skip', 'skip'),
   icub3d_Spell('mouse', 'Ursol\'s Vortex', 'skip', 'skip'),
   icub3d_Spell('help', 'Innervate', 'skip', 'skip'),
   icub3d_Spell('help', 'Convoke the Spirits'),
   icub3d_Spell('help', 'Soulshape'),
