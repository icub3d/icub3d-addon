icub3d_Priest_Spells = {
   ...
   icub3d_Spell('help', 'Renew', 'harm', 'Vampiric Touch', 'harm', 'Schism', 'skip', 'skip'), 
   icub3d_Spell('help', 'Holy Word: Sanctify', 'harm', 'Mind Blast', 'skip', 'skip'),
   icub3d_Spell('harm', 'Shadow Word: Pain'),
   icub3d_Spell('help', 'Power Word: Radiance', 'help', 'Prayer of Healing', 'harm', 'Void Eruption', 'skip', 'skip'),
   ...
   icub3d_Spell('mouse', 'Power Word: Barrier', 'harm', 'Divine Hymn'),
   ...
   icub3d_Spell('help', 'Purify', 'help', 'Purify Disease', 'skip', 'skip'),
